/**
 * Invoice PDF document — render with `pdf(<InvoicePdf ... />).toBlob()`.
 */
    ...
    >
      <Page size="A4" style={pdfStyles.page} wrap>
        ...
        <View style={pdfStyles.docHeader}>
          <Text style={pdfStyles.docTitle}>請　求　書</Text>
          <Text style={pdfStyles.docNumber}>No. {invoice.number}</Text>
        </View>
        ...
        <View style={pdfStyles.metaRow}>
          <View style={pdfStyles.metaCol}>
            ...
            <View style={{ marginTop: 8 }}>
              ...
              <Text style={pdfStyles.smallText}>
                支払期日：{fmtDate(invoice.dueDate)}
              </Text>
              {invoice.paidAt ? (
                <Text style={pdfStyles.smallText}>
                  入金日：{fmtDate(invoice.paidAt)}
                </Text>
              ) : null}
            </View>
          </View>
        ...
        <View style={pdfStyles.subjectSection}>
          ...
          <Text style={pdfStyles.subjectTitle}>{invoice.title || "—"}</Text>
        </View>

        {/* Total banner */}
        <Text style={pdfStyles.amountBanner}>
          ご請求金額　{formatYen(invoice.total)}
        </Text>
        ...
        {invoice.notes ? (
          <View style={pdfStyles.section}>
            ...
            <Text style={pdfStyles.sectionBody}>{invoice.notes}</Text>
          </View>
        ) : null}
